$(document).ready(function() {
 ...
 //salvare l'immagine nel db come stringa è molto utile perchè è un path assoluto
 //però appesantisce leggermente il database
 //in alternativa si può utilizzare il servizio cloudinary
